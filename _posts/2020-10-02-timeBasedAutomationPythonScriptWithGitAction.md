...
date:       2020-10-02 +0900
author:     PJH
# categories: [Dummy]
tags:       [githup]
---

![title](/assets/images/2020-10-02-timeBasedAutomationPythonScriptWithGitAction/001.png)
...
![title](/assets/images/2020-10-02-timeBasedAutomationPythonScriptWithGitAction/002.png){: width="300px"}

1. 파이썬 스크립트 하나를 실행시키는 정도라면, 위 스크린샷의 「Python application」으로 충분하다.
이걸 선택.
![title](/assets/images/2020-10-02-timeBasedAutomationPythonScriptWithGitAction/003.png){: width="300px"}
...
![title](/assets/images/2020-10-02-timeBasedAutomationPythonScriptWithGitAction/004.png)
누른다.
...
![title](/assets/images/2020-10-02-timeBasedAutomationPythonScriptWithGitAction/005.png){: width="300px"}
