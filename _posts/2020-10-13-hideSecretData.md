...
![title](/assets/images/2020-10-13-hideSecretData/001.png)
...
![title](/assets/images/2020-10-13-hideSecretData/002.png)
...
![title](/assets/images/2020-10-13-hideSecretData/003.png)

Actions를 작업하려는 레포지토리에서 Settings에 접속한다.

![title](/assets/images/2020-10-13-hideSecretData/004.png)

Secrets 선택하고 New secret 클릭한다.

![title](/assets/images/2020-10-13-hideSecretData/005.png)

상수명(Name)과 값(Value)을 집어넣고 Add Secret 버튼을 클릭한다.
참고로, 여기 입력한 값은 일단 결정하고 나면 자신도 볼 수 없게 된다.

![title](/assets/images/2020-10-13-hideSecretData/006.png)
...
![title](/assets/images/2020-10-13-hideSecretData/007.png)
